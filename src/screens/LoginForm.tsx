...
const LoginForm = () => {
  ...
  return (
    <View style={tw`flex-1 items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600`}>
      {loading && (
      ...
      <View style={tw`bg-white p-10 rounded-3xl shadow-lg w-full max-w-md`}>
        <Text style={tw`text-4xl font-bold mb-6 text-center text-gray-800`}>Welcome Back</Text>
        ...
        <Button title="Login" onPress={handleSubmit} color="#1E90FF" />
        <View style={tw`mt-6 text-center`}>
          <TouchableOpacity onPress={() => navigation.navigate("Signup")}>
            <Text style={tw`text-blue-500 hover:underline`}>Don't have an account? Sign up</Text>
          </TouchableOpacity>
        </View>
        <View style={tw`mt-4 text-center`}>
          <TouchableOpacity onPress={() => navigation.navigate("ForgotPassword")}>
            <Text style={tw`text-blue-500 hover:underline`}>Forgot Password?</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
